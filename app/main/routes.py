...
from app import db
from app.main.forms import EditProfileForm,EmptyForm,SearchForm,PostForm,MessageForm
...
def explore():
	...
	return render_template('index.html',posts=posts.items,title=_('Explore'),next_url=next_url,prev_url=prev_url)
